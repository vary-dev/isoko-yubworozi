...
export default async function BookPage({
  ...
  return (
    <main id="main-content">
      <Navbar />
      <section className="min-h-[80vh] bg-[#f5faf6] pb-20 pt-32">
        <div className="section-shell">
          ...
          <div className="grid gap-10 rounded-[2rem] border border-isoko-dark/8 bg-white p-6 shadow-[0_20px_60px_rgba(6,59,31,.08)] md:grid-cols-[280px_1fr] md:p-10">
            <div className="relative aspect-[3/4] overflow-hidden rounded-2xl bg-isoko-light shadow-lg">
              <Image
                fill
                priority
                sizes="280px"
            ...
            <div className="self-center">
              <div className="flex flex-wrap gap-2">
                <span className="rounded-full bg-isoko-light px-3 py-1 text-xs font-extrabold text-isoko-primary">
                  {book.category}
                </span>
              ...
              <h1 className="mt-5 text-3xl font-bold text-isoko-dark sm:text-4xl">
                {book.title}
              </h1>
